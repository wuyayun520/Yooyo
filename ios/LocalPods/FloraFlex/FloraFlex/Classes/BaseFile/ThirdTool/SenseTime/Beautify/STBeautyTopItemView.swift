...
class STBeautyTopItemView: UIView {
    ...
    private lazy var resetBtn: UIButton = {
        let btn = UIButton()
        btn.setImage(UIImage.bundleBy(name: "icon_cz_nor"), for: .normal)
...
extension STBeautyTopItemView {
    ...
    func setupSubviews() {
        ...
        for (i, item) in items.enumerated() {
            ...
            if i == 0 {
                ...
                let startX = DeleteClientThen.shared.direction == .rightToLeft ? (Int(kLet_halfData)-6-buttonW/2):6+buttonW/2
        ...
        resetBtn.snp.makeConstraints { make in
            make.leading.equalTo(kLet_halfData-10-30)
            make.top.equalTo(10)
    ...
    func setButtonStatus(sender: UIButton) {
        ...
        self.selectButton.titleLabel?.font = UIFont.groupSize(type: .Semibold, fontSize: 14)
    ...
    @objc func resetBtnClick() {
        ...
        ClickReactiveCompatible.anyAppearConfig(message: "Restore to default Beautify Settings".localized, leftBtnTitle: "Cancel".localized, rightBtnTitle: "OK".localized, leftBlock: {
