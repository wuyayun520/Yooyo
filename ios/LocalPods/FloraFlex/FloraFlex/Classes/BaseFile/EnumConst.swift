...
enum MiniLoginClusterLiteral: String {
    //: case AppleLogin
...
enum FillContiguousBytes: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum UmbraColumnConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum TitleExpressionConvertible: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum SharedInsetTarget: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum ButtonTotalervalLiteral: Int {
    //: case Unavailable = 0
...
enum PointCaseIterable: CaseIterable {
...
enum EndueProtectionBasicType: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
