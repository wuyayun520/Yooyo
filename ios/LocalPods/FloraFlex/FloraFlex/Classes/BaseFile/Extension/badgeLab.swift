...
class PageBadgeLab: UILabel {
    ...
    private func addFor() {
        ...
        layer.backgroundColor = UIColor.welt().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.groupSize(type: .Medium, fontSize: 11)
