...
/*: / :*/
fileprivate let kStr_pageData:[Character] = ["/"]

/*: "\n" :*/
fileprivate let kStr_backValue:[Character] = ["\n"]
...
class PathViewDelegate: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        titleValue(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        titleValue(placeholder: nil, placeholderColor: nil)
    }
}
...
extension PathViewDelegate {
    ...
    private func titleValue(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(ToLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(ToLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-ToLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: EqualContainerInset().top, left: EqualContainerInset().left, bottom: EqualContainerInset().bottom, right: EqualContainerInset().right)
...
extension PathViewDelegate: UITextViewDelegate {
