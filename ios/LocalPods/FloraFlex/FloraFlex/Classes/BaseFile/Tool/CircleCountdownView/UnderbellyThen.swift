...
fileprivate let kStr_userName:[UInt8] = [0x6,0xb,0x6,0x11,0xc5,0x0,0xc,0x1,0x2,0xf,0xd7,0xc6,0xbd,0x5,0xfe,0x10,0xbd,0xb,0xc,0x11,0xbd,0xff,0x2,0x2,0xb,0xbd,0x6,0xa,0xd,0x9,0x2,0xa,0x2,0xb,0x11,0x2,0x1]

fileprivate func titleStyle(label num: UInt8) -> UInt8 {
...
let kLet_licenseName = 3.0

//: class CircleCountdownView: UIView {
class UnderbellyThen: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.priority() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kStr_userName.map{titleStyle(label: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.groupSize(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: kLet_licenseName / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: kLet_licenseName / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - kLet_licenseName,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - kLet_licenseName)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.priority().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kLet_licenseName
...
extension UnderbellyThen {
    /// 创建UI
    //: private func createUI() {
    private func clickOo() {
    ...
    func miniTime(totalTime: Int, currTime: Int) {
