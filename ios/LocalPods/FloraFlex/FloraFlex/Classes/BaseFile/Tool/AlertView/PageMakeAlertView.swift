...
fileprivate let kStr_actionText:[Character] = ["b","t","n","_","m","e","_","b","a","c","k","_","c","o","n","t","i"]
fileprivate let kStr_viewContent:[Character] = ["n","u","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let kStr_buttonData:[UInt8] = [0xf7,0xf0,0xf7,0xea,0xb6,0xfd,0xf1,0xfa,0xfb,0xec,0xa4,0xb7,0xbe,0xf6,0xff,0xed,0xbe,0xf0,0xf1,0xea,0xbe,0xfc,0xfb,0xfb,0xf0,0xbe,0xf7,0xf3,0xee,0xf2,0xfb,0xf3,0xfb,0xf0,0xea,0xfb,0xfa]

private func scienceLaboratory(group num: UInt8) -> UInt8 {
    return num ^ 158
}
...
class PageMakeAlertView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(untilTo), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(appError), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: StreetwiseAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(kStr_actionText) + String(kStr_viewContent))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kStr_buttonData.map{scienceLaboratory(group: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func palpate(title: String, isTouch: Bool) {
