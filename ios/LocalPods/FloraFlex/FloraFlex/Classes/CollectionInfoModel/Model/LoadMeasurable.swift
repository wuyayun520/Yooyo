...
/*: "id" :*/
fileprivate let kStr_rowData:String = "iobserver"
...
struct LoadMeasurable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: ModelMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [CountModelType]? // 相册
    ...
    var aiExtraInfo = ProfitsHandyJSON() // AI模型
    //: var vipSkinId = 0
...
struct ModelMeasurable: HandyJSON {
    ...
    var list: [PageHandyJSON]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct PageHandyJSON: HandyJSON {
...
struct CountModelType: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func dataConverterSearched(compareTo: CountModelType) -> Bool {
        //: return
        return
...
struct ProfitsHandyJSON: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum GalleryEffectMeasurable: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
