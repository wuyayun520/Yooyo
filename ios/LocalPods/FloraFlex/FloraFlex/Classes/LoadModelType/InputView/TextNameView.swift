...
open class TextNameView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = TextNameView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func barBind() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(revolutionContext),
    ...
    @objc private func revolutionContext() {
