...
fileprivate let kStr_needValue:[UInt8] = [0xaa,0xad,0xaa,0xb7,0xeb,0xa0,0xac,0xa7,0xa6,0xb1,0xf9,0xea,0xe3,0xab,0xa2,0xb0,0xe3,0xad,0xac,0xb7,0xe3,0xa1,0xa6,0xa6,0xad,0xe3,0xaa,0xae,0xb3,0xaf,0xa6,0xae,0xa6,0xad,0xb7,0xa6,0xa7]

/*: "#E6BD8B" :*/
fileprivate let kStr_shareText:String = "point share message to#E6BD8B"

/*: "+ :*/
fileprivate let kStr_originalData:String = "+"

/*: "get json error" :*/
fileprivate let kStr_styleImageText:String = "get jadd if"
fileprivate let kStr_makeTitle:String = "dataro"
fileprivate let kStr_showValue:String = "file"
...
// __CLOSE_PRINT__
//
//  WarpathNameViewReactiveCompatible.swift
//  AbroadTalking
//
...
class WarpathNameViewReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kStr_needValue.map{$0^195}, encoding: .utf8)!)
    }
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.groupSize(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (String(kStr_shareText.suffix(7))))
...
extension WarpathNameViewReactiveCompatible {
    //: func setPointData(point: String, isminiStr: Bool = false) {
    func languageStr(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(kStr_shareText.suffix(7))))!, .font: UIFont.groupSize(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (String(kStr_shareText.suffix(7))))!, .font: UIFont.groupSize(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = LoadGrappleEffectTool.default.sunnahType(type: .VideoCall_femalePoint)
            ...
            if ViewManagerAddrTool.share.interfaceLang == CountClusterLiteral.ar.rawValue {
                ...
                url = LoadGrappleEffectTool.default.sunnahType(type: .videoCall_femalePoint_ar)
                ...
                url = LoadGrappleEffectTool.default.sunnahType(type: .videoCall_femalePoint_es)
                ...
                url = LoadGrappleEffectTool.default.sunnahType(type: .videoCall_femalePoint_pt)
            }
            ...
            pathLine(message: (String(kStr_styleImageText.prefix(5)) + "son " + kStr_makeTitle.replacingOccurrences(of: "data", with: "er") + kStr_showValue.replacingOccurrences(of: "file", with: "r")))
        }
    }
}
