...
fileprivate let kStr_frameCellTitle:[UInt8] = [0x4d,0x4a,0x4d,0x50,0xc,0x47,0x4b,0x40,0x41,0x56,0x1e,0xd,0x4,0x4c,0x45,0x57,0x4,0x4a,0x4b,0x50,0x4,0x46,0x41,0x41,0x4a,0x4,0x4d,0x49,0x54,0x48,0x41,0x49,0x41,0x4a,0x50,0x41,0x40]
...
class ViewEqualThen: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [SharedModelType()]
    ...
    override init(frame: CGRect) {
        ...
        super.init(frame: frame)
        //: self.setupSubviews()
        self.dorsalVertebraSubviews()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: kStr_frameCellTitle.map{$0^36}, encoding: .utf8)!)
    }
    ...
    func viewTo(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.priority()
    ...
    func processSpecs(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.largesse(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.largesse(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension ViewEqualThen {
    // 添加视图
    //: private func setupSubviews() {
    private func dorsalVertebraSubviews() {
