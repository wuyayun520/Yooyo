...
let kLet_appFirstValue = originalScene(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let kLet_messageValue = originalScene(w: 200)
//: let VideocellLineSpeing = 3
let kLet_backValue = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct ShareTransformable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
