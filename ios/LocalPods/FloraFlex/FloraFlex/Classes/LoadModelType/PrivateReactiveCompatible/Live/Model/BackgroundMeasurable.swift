...
struct FailureToMsgInfo: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var messageType = 0
...
struct DanmuViewTransformable: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""
