...
/*!消息体数据*/
//: @class LabelOffAimChromosphereJsonModel, VideoJsonModel, TargetModel, AbTalkingChatMsgGiftModel, ActualJsonModel, FailureReactiveCompatible, AddModel, ViewJsonModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, EmptyContentModel;
@class LabelOffAimChromosphereJsonModel, VideoJsonModel, TargetModel, RefreshJsonModel, ActualJsonModel, FailureReactiveCompatible, AddModel, ViewJsonModel, MethodModel, DataModel, BuildModel, EmptyContentModel;

//: @interface KeyModel : BaseJsonModel
@interface KeyModel : BaseJsonModel

//: @property (nonatomic, strong)LabelOffAimChromosphereJsonModel *msgInfo;
@property (nonatomic, strong)LabelOffAimChromosphereJsonModel *msgInfo;

//: @property (nonatomic, strong)VideoJsonModel *user;
@property (nonatomic, strong)VideoJsonModel *user;

//: @property (nonatomic, strong)TargetModel *toUser;
@property (nonatomic, strong)TargetModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)RefreshJsonModel *gift;

//: @property (nonatomic, strong)ActualJsonModel *tips;
@property (nonatomic, strong)ActualJsonModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)DataModel *quoteMsgInfo;

//: @property (nonatomic, strong)FailureReactiveCompatible *userInfoModel;
@property (nonatomic, strong)FailureReactiveCompatible *userInfoModel;
...
//: @interface LabelOffAimChromosphereJsonModel : BaseJsonModel
@interface LabelOffAimChromosphereJsonModel : BaseJsonModel
...
//: @property (nonatomic, strong) AddModel *intimatePhoto; 
@property (nonatomic, strong) AddModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) ViewJsonModel *video; 
@property (nonatomic, strong) ViewJsonModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) MethodModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) EmptyContentModel *wantGift; 
@property (nonatomic, strong) EmptyContentModel *wantGift; /// 想要礼物

//: @end
@end

/// 私密照片模型
//: @interface AddModel : BaseJsonModel
@interface AddModel : BaseJsonModel
...
/// 视频（包含私密视频）模型
//: @interface ViewJsonModel: BaseJsonModel
@interface ViewJsonModel: BaseJsonModel
...
@interface MethodModel: BaseJsonModel
...
//消息发送人
//: @interface VideoJsonModel : BaseJsonModel
@interface VideoJsonModel : BaseJsonModel
...
//对方
//: @interface TargetModel : BaseJsonModel
@interface TargetModel : BaseJsonModel
...
@interface RefreshJsonModel : BaseJsonModel
...
//: @interface ActualJsonModel : BaseJsonModel
@interface ActualJsonModel : BaseJsonModel
...
//: @interface EmptyContentModel : BaseJsonModel
@interface EmptyContentModel : BaseJsonModel
...
@interface DataModel : BaseJsonModel
...
@property (nonatomic, strong) BuildModel *renderData;
...
@interface BuildModel : BaseJsonModel
