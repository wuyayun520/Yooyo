...
@objcMembers class ClutterUpModelType: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: SprechstimmeHandyJSON?
    //: var gift: TalkingMsgGiftModel?
    var gift: VoiceMeasurable?
    //: var user: TalkingMsgUserModel?
    var user: OmitUserModel?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: InputMakeModelType?
...
class SprechstimmeHandyJSON: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class OmitUserModel: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class InputMakeModelType: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
