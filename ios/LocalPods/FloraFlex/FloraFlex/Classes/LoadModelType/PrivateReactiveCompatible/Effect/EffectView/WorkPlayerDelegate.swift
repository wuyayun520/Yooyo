...
fileprivate let kStr_seatSizeContent:[UInt8] = [0x51,0x56,0x51,0x4c,0x10,0x5b,0x57,0x5c,0x5d,0x4a,0x2,0x11,0x18,0x50,0x59,0x4b,0x18,0x56,0x57,0x4c,0x18,0x5a,0x5d,0x5d,0x56,0x18,0x51,0x55,0x48,0x54,0x5d,0x55,0x5d,0x56,0x4c,0x5d,0x5c]
...
class WorkPlayerDelegate: TableItemView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kStr_seatSizeContent.map{$0^56}, encoding: .utf8)!)
    }
    ...
    override func detailWith() {
        ...
        let filePath = TableAnimatTool.shared.clickRecord(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.anagrammatise(effectItemView: self, success: true)
...
extension WorkPlayerDelegate: SVGAPlayerDelegate {
