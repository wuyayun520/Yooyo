...
/*: "id" :*/
fileprivate let kStr_normalValue:[Character] = ["i","d"]
...
struct EngineHandyJSON: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct SharedModelType: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct CollectionMeasurable: HandyJSON {
