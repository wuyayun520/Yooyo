...
fileprivate let kStr_kindTitle:[UInt8] = [0x64,0x63,0x64,0x79,0x25,0x6e,0x62,0x69,0x68,0x7f,0x37,0x24,0x2d,0x65,0x6c,0x7e,0x2d,0x63,0x62,0x79,0x2d,0x6f,0x68,0x68,0x63,0x2d,0x64,0x60,0x7d,0x61,0x68,0x60,0x68,0x63,0x79,0x68,0x69]

private func instanceData(text num: UInt8) -> UInt8 {
    return num ^ 13
}

/*: "JXBannerCellID" :*/
fileprivate let kStr_sizeData:[Character] = ["J","X","B","a","n","n","e","r","C"]
fileprivate let kStr_keyContent:[Character] = ["e","l","l","I","D"]
...
class CompartmentBannerCell: UITableViewCell {
    //: private var adBannderListData = [SocialAdBannerModel]()
    private var adBannderListData = [RawDataBannerModel]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kStr_kindTitle.map{instanceData(text: $0)}, encoding: .utf8)!)
    }
...
extension CompartmentBannerCell: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(kStr_sizeData) + String(kStr_keyContent)))
    }
...
extension CompartmentBannerCell {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func birthday(bannerData: [RawDataBannerModel]) {
