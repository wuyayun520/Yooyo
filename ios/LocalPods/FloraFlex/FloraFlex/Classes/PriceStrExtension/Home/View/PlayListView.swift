...
fileprivate let kStr_sexName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "JXBannerCellID" :*/
fileprivate let kStr_makeName:String = "true view lab byJXBa"
fileprivate let kStr_textValue:String = "equal letllID"

/*: "#FFFFFF" :*/
fileprivate let kStr_targetValue:String = "gift model appear if#FFFFFF"

/*: "#BDB8B5" :*/
fileprivate let kStr_objectName:String = "#BDB8B5false m"
...
protocol UpwardsObjectProtocol: NSObjectProtocol {
    // 加载更多数据
...
class PlayListView: UICollectionReusableView {
    ...
    weak var delegate: UpwardsObjectProtocol?
    //: var listData: [PremiumStarListModel]?
    var listData: [ShadowListModel]? // 巨星计划数据
    //: var adBannderListData: [SocialAdBannerModel]?
    var adBannderListData: [RawDataBannerModel]? // 广告banner数据

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: kStr_sexName.reversed(), encoding: .utf8)!)
    }
...
extension PlayListView {
    ...
    func juxtaposed(data: [ShadowListModel]) {
        //: self.listData = data
        self.listData = data
    }
    ...
    func colorData(data: [RawDataBannerModel]) {
...
extension PlayListView: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(kStr_makeName.suffix(4)) + "nnerCe" + String(kStr_textValue.suffix(4))))
    }
    ...
    func jxBanner(_: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
        ...
        tempCell.imageView.failureFinish(urlStr: model?.pic ?? "", placeImg: UIImage.imageBy())
                  ...
                  builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder
    {
        ...
        pageControl.activeColor = UIColor(hex: (String(kStr_targetValue.suffix(7))))!
        //: pageControl.inactiveSize = CGSize(width: 6, height: 6)
        pageControl.inactiveSize = CGSize(width: 6, height: 6)
        //: pageControl.inactiveColor = UIColor(hex: "#BDB8B5")!
        pageControl.inactiveColor = UIColor(hex: (String(kStr_objectName.prefix(7))))!
...
extension PlayListView {
    ...
    private func res() {
        ...
        bannerView.snp.makeConstraints { make in
            ...
            make.size.equalTo(CGSize(width: kLet_halfData - 30, height: 84))
        }
    }
}
