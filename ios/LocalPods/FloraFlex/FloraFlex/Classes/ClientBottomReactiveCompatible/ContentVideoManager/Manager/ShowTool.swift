...
extension ShowTool {
    ...
    func textCamera(_ frontCamera: Bool) {
        ...
        self.sideFront(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func atCamera(_ openCamera: Bool) {
    ...
    func portion() {
        ...
        DispatchQueue.main.async {
            ...
            self.startWithObject(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension ShowTool {
    ...
    private func sideFront(front: Bool) {
...
extension ShowTool {
    ...
    func underList() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(frameMention(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(routeSub(notif:)),
    ...
    @objc private func frameMention(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func canto(notif: Notification) {
    ...
    @objc func routeSub(notif: Notification) {
...
extension ShowTool {
    ...
    func clickFrom() {
        ...
        if self.infoModel?.videoStage == .Waiting {
            ...
            startWithObject(smallWindow: false)
        ...
        //: } else if self.infoModel?.videoStage == .Calling {
            ...
            //: } else {
                ...
                startWithObject(smallWindow: true)
            }
        }
    ...
    func startWithObject(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_intervalName == true else {
