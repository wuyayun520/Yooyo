...
fileprivate let kStr_topErrorData:[UInt8] = [0x3c,0x41,0x3c,0x47,0xfb,0x36,0x42,0x37,0x38,0x45,0xd,0xfc,0xf3,0x3b,0x34,0x46,0xf3,0x41,0x42,0x47,0xf3,0x35,0x38,0x38,0x41,0xf3,0x3c,0x40,0x43,0x3f,0x38,0x40,0x38,0x41,0x47,0x38,0x37]

fileprivate func administratorTable(greet num: UInt8) -> UInt8 {
...
/*: "icon_chat_start" :*/
fileprivate let kStr_playerValue:String = "iattentionon"
fileprivate let kStr_failValue:String = "stpatht"

/*: "#752FE9" :*/
fileprivate let kStr_tableValue:[Character] = ["#","7","5","2","F","E","9"]

/*: "#F5F5F5" :*/
fileprivate let kStr_valueCenterName:String = "section label#F5F5F"
fileprivate let kStr_acrossLabelValue:[Character] = ["5"]

/*: "@ :*/
fileprivate let kStr_triumphTitle:String = "view"

/*: "btn_feed_dianzan_nor" :*/
fileprivate let kStr_removeErrorData:[UInt8] = [0xfa,0xc,0x6,0xf7,0xfe,0xfd,0xfd,0xfc,0xf7,0xfc,0x1,0xf9,0x6,0x12,0xf9,0x6,0xf7,0x6,0x7,0xa]

fileprivate func reloadSession(by num: UInt8) -> UInt8 {
...
/*: "btn_feed_reply_nor" :*/
fileprivate let kStr_makeToData:[Character] = ["b","t","n","_","f","e","e","d","_","r","e","p","l","y","_","n"]
fileprivate let kStr_ageCommentData:String = "load"
...
class CaterReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kStr_topErrorData.map{administratorTable(greet: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.bundleBy(name: (kStr_playerValue.replacingOccurrences(of: "attention", with: "c") + "_chat_" + kStr_failValue.replacingOccurrences(of: "path", with: "ar")))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(kStr_tableValue)))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(kStr_valueCenterName.suffix(6)) + String(kStr_acrossLabelValue)))
...
extension CaterReactiveCompatible {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func onFlushWindow(_ model: SprechgesangListModel) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.failureFinish(urlStr: model.headPic, placeImg: UIImage.infoPlayer())
        ...
        previewImgView.timeFinish(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: kStr_removeErrorData.map{reloadSession(by: $0)}, encoding: .utf8)! : (String(kStr_makeToData) + kStr_ageCommentData.replacingOccurrences(of: "load", with: "or"))
        //: statusIcon.image = UIImage.bundleBy(name: typeImgStr)
        statusIcon.image = UIImage.bundleBy(name: typeImgStr)
...
extension CaterReactiveCompatible {
    ...
    private func barFile() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((kLet_halfData - 128) / 2)
        }
