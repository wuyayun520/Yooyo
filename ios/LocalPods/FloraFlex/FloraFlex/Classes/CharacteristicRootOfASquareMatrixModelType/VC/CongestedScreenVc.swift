...
class CongestedScreenVc: LayerRecognizerDelegate {
    ...
    lazy var topView: MakeTopView = {
        ...
        let view = MakeTopView(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: ShowCheckReactiveCompatible = {
    ...
    lazy var usePhotoView: FillInfoView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = FillInfoView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension CongestedScreenVc {
    //: func crushBtnTool(modle: TalkingMomentModel) {
    func rake(modle: ModelTransformable) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==LocationThen.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == LocationThen.share.loginUserMode.sex
        }
