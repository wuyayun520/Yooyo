...
Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  #s.public_header_files = 'FloraFlex/Classes/**/{FloraFlex,NSString+AES128,BaseJsonModel,RBDMuteSwitch,AbTalkingAuditGiftBroadcastView}.h', 'FloraFlex/Classes/BaseFile/**/*.h', 'FloraFlex/Classes/MessageModule/IMSDKModule/IMChat/**/*.h'
  s.source_files = 'FloraFlex/Classes/**/*'
  s.resources = "FloraFlex/Resources/*.bundle"
  s.vendored_libraries = 'FloraFlex/Classes/**/*.a'
