...
class _SubscriptionsPageState extends State<SubscriptionsPage> with TickerProviderStateMixin {
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    DateTime expiry;
    if (purchaseDetails.productID == 'YooyoWeekVIP') {
      expiry = now.add(const Duration(days: 7));
    } else if (purchaseDetails.productID == 'YooyoMonthVIP') {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<_Privilege>> planPrivileges = [
      // Weekly
      [
        _Privilege(icon: Icons.music_note, text: 'Unlimited browsing of works'),
        _Privilege(icon: Icons.block, text: 'Remove advertisements'),
      ],
      // Monthly
      [
        _Privilege(icon: Icons.music_note, text: 'Unlimited browsing of works'),
                              ...
                              builder: (context, child) {
                                return Transform.scale(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      gradient: const LinearGradient(
                                        colors: [Color(0xFFE922DF), Color(0xFF9C27B0)],
                                        begin: Alignment.topLeft,
                                        end: Alignment.bottomRight,
                                      ),
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    gradient: selected 
                                        ...
                                        : null,
                                    color: selected ? null : const Color(0xFF2A2D35),
                                    borderRadius: BorderRadius.circular(16),
                                    border: Border.all(
                                      color: selected ? const Color(0xFFE922DF) : Colors.grey.withOpacity(0.3),
                                      width: 2,
                                    ),
                                    boxShadow: [
                                      BoxShadow(
                                        color: selected 
                                            ? const Color(0xFFE922DF).withOpacity(0.3)
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          Text(
                                            plan.subTitle,
                                            style: TextStyle(
                                              color: selected ? Colors.white.withOpacity(0.9) : Colors.grey[400],
                                              fontSize: 14,
                                            ),
                                          ),
                                          ...
                                          Text(
                                            plan.desc,
                                            style: TextStyle(
                                              color: selected ? const Color(0xFFFFD700) : const Color(0xFFE922DF),
                                              fontWeight: FontWeight.bold,
                                              fontSize: 14,
                                            ),
                                          ),
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () => _launchURL('https://sites.google.com/view/yooyoprivacy/page'),
                              child: Text(
                                'Privacy Policy',
                                style: TextStyle(
